...
export function FirstComponent(props) {
    ...
    return <div> <img src={g1} alt="Logo" /> <img src={g2} alt="Logo" /> <img src={g3} alt="Logo" /> </div> ;
  }

  export function SecondeComponent(props) {
    return <div>  <Card style={cardimg1} >   <img src={group8} alt="Logo" /> </Card> <Card style={cardimg1} > <img src={group} alt="Logo" /></Card> <Card style={cardimg1}><img src={group2} alt="Logo" /> </Card></div> ;
  }
